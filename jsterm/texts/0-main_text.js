var usuarioDefault = 'leyente',
    ...
    ayuda2 = '<br />Para cancelar el ingreso de un comando usa Control + C. Esto es muy útil si la terminal se queda «colgada»; es decir, si deja de responder, usualmente por un erróneo ingreso de comandos.<br /><br />¿No sabes qué hacer ahora? Prueba con escribir «ls» o «tree» para ver cuáles ficheros puedes acceder.',
    ayudaBoton = "?",
    comandos = {
